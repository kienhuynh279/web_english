...
<div class="form-group col-sm-6">
    <x-input-form type="text" label="Tiêu đề English:" name="Title_en" classGroup="col-md" class="" placeholder="Tiêu đề" :value="$form->title_en ?? ''" />
</div>
...
<div class="form-group col-sm-6">
    <x-input-form type="text" label="Description Meta:" name="Meta_Desc" classGroup="col-md" class="" placeholder="Meta Description" :value="$form->meta_description ?? ''" />
</div>

<div class="form-group col-sm-6">
    <x-input-form type="text" label="Title Meta:" name="Meta_Title" classGroup="col-md" class="" placeholder="Meta Title" :value="$form->meta_title ?? ''" />
</div>
...
<div class="form-group col-sm-6">
    <x-input-form type="text" label="Rating" name="Rating" classGroup="col-md" class="" placeholder="Tiêu đề" :value="$form->rating ?? ''" />
</div>


<div class="form-group col-sm-3">
    <x-input-form type="text" label="Checked" name="Checked" classGroup="col-md" class="" placeholder="Checked" :value="$form->checked ?? ''" />
</div>

<div class="form-group col-sm-3">
    <x-input-form type="text" label="Chức vụ" name="Position" classGroup="col-md" class="" placeholder="Chức vụ" :value="$form->position ?? ''" />
</div>
