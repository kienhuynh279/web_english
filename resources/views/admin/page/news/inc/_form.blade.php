...
<div class="form-group col-sm-6">
  <x-input-form type="text" id="title_en" label="Tiêu đề English:" name="Title_en" classGroup="col-md" class=""
    placeholder="Tiêu đề" :value="$blog->title_en ?? ''" />
</div>
...
<div class="form-group col-sm-6 px-3">
  ...
  <div class="md-form">
    <textarea id="summary" name="Summary"
      class="md-textarea form-control">{{ $blog->summary ?? old('summary') }}</textarea>
  </div>
...
<div class="form-group col-sm-6 px-3">
  ...
  <div class="md-form">
    <textarea id="summary_en" name="Summary_en"
      class="md-textarea form-control">{{ $blog->summary_en ?? old('summary_en') }}</textarea>
  </div>
  <div class="col-lg-12 messages text-danger"></div>
</div>
...
<div class="form-group col-sm-6 px-3">
  ...
  <div class="md-form">
    <textarea id="content" name="Content"
      class="md-textarea form-control">{{ $blog->content ?? old('content') }}</textarea>
  </div>
  <div class="col-lg-12 messages text-danger"></div>
</div>
<div class="form-group col-sm-6 px-3">
  ...
  <div class="md-form">
    <textarea id="content_en" name="Content_en"
      class="md-textarea form-control">{{ $blog->content_en ?? old('content_en') }}</textarea>
  </div>
  <div class="col-lg-12 messages text-danger"></div>
</div>
...
<div class="form-group col-sm-6">
  <x-input-form type="text" label="Description Meta:" name="Meta_Desc" classGroup="col-md" class=""
    placeholder="Checked" :value="$blog->meta_description ?? ''" />
</div>
