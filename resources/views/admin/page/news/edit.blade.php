...
@section('main')
<form enctype="multipart/form-data" id="main" action="{{ route('adminNewPutEdit', $blog['id']) }}" method="POST" novalidate>
    @csrf
    ...
    <div class="card">
        ...
        <div class="card-body d-flex flex-wrap">
            ...
            <div class="form-group col-md-6 px-3">
                ...
                <div class="w-100">
                    <input type="text" id="title" name="Title" class="form-control" placeholder="Tiêu đề" value="{{ $blog['title'] }}">
                </div>
            ...
            <div class="form-group col-md-6 px-3">
                ...
                <div class="w-100">
                    <input type="text" id="tittle_en" name="Title_en" class="form-control" placeholder="Tiêu đề bằng tiếng anh" value="{{ $blog['title_en'] }}">
                </div>
                <div class="col-lg-12 messages text-danger"></div>
            </div>
            ...
            <div class="form-group col-md-6 px-3">
                ...
                <div class="w-100">
                    <input type="text" id="slug" name="Slug" class="form-control" placeholder="Slug" value="{{ $blog['slug'] }}">
                </div>
                <div class="col-lg-12 messages text-danger"></div>
            </div>
            <div class="form-check col-md-3 px-3">
                ...
                <div class="form-control d-flex gap-2 align-items-center" style="gap: 5px;">
                    <input type="checkbox" id="status" name="Status" {{ $blog['status'] == 1 ? "checked" : ""}}>
            ...
            <div class="form-check col-md-3 px-3">
                ...
                <div class="form-control d-flex gap-2 align-items-center" style="gap: 5px;">
                    <input type="checkbox" id="high_flg" name="High_flg" {{ $blog['high_flg'] == 1 ? "checked" : ""}}>
            ...
            <div class="form-group col-md-6 px-3">
                ...
                <div class="md-form">
                    <textarea id="summary" name="Summary" class="md-textarea form-control">{{ $blog['summary'] }}</textarea>
                </div>
                <div class=" col-lg-12 messages text-danger"></div>
            </div>
            <div class="form-group col-md-6 px-3">
                ...
                <div class="md-form">
                    <textarea id="summary_en" name="Summary_en" class="md-textarea form-control">{{ $blog['summary_en'] }}</textarea>
                </div>
                <div class=" col-lg-12 messages text-danger"></div>
            </div>
            <div class="form-group col-md-6 px-3">
                ...
                <div class="md-form">
                    <textarea id="content" name="Content" class="md-textarea form-control">{{ $blog['content'] }}</textarea>
                </div>
                <div class=" col-lg-12 messages text-danger"></div>
            </div>
            <div class="form-group col-md-6 px-3">
                ...
                <div class="md-form">
                    <textarea id="content_en" name="Content_en" class="md-textarea form-control">{{ $blog['content_en'] }}</textarea>
                </div>
                <div class=" col-lg-12 messages text-danger"></div>
            </div>
        </div>
