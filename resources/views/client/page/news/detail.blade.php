                ...
                <div class="navigation-area">
                  <div class="row">
                    <div
                      ...
                      <div class="thumb">
                        {{-- <a href="{{ route('newsDetail') }}"><img class="img-fluid"
                          src="{{ asset('dist/img/blog/prev.jpg') }}" alt=""></a> --}}
                      </div>
                      <div class="arrow">
                    ...
                    <div
                      ...
                      <div class="thumb">
                        {{-- <a href="{{ route('newsDetail') }}"><img class="img-fluid"
                          src="{{ asset('dist/img/blog/next.jpg') }}" alt=""></a> --}}
                      </div>
                    </div>
                  </div>
                </div>
>>>>>>> 8eed9da2c1dc13e8a64761992ef40627ad9505a6
        ...
        <div class="navigation-area">
          <div class="row">
            <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
              <div class="thumb">
                <a href="{{ route('newsDetail') }}"><img class="img-fluid" src="{{ asset('dist/img/blog/prev.jpg') }}"
                    alt=""></a>
              </div>
              <div class="arrow">
                <a href="{{ route('newsDetail') }}"><i class="text-white ti-arrow-left"></i></a>
