...
<section class="course_details_area section_gap">
    <div class="container">
        <div class="col-lg-12">
            <div class="row">
                <a href="#">
                    <p style="color:black">Home\ Docs\Outstanding Docs\Name </p>
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 right-contents">
                ...
                <a href="#" class="btn btn-register">Dowload Files</a>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <p style="font-size:12px">40 sentences</p>
                                        </div>
                                        <div class="col-sm-6">
                                            <p>60 minutes</p>
                                        </div>
