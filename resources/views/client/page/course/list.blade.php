<section class="my-section">
    <div class="container">
        <div class="col-sm-12">
            <div class="row">
                <a href="#">
                    <p style="color:black">Trang chủ \ Ôn Thi THPT</p>
                </a>
            </div>
        </div>
        <div class="row">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            {{-- <img src="{{ asset('dist/img/banner/banner-2.jpg') }}" alt="" width="100%"
                            height="100%"> --}}
                            @if(!empty($banner))
                            @foreach($banner as $item )
                            @if($item->status == 1)
                            @if($item->id == 108)
                            <img src="{{Storage::url('/upload/img/banner/'.$item->avatar)}}" width="100%" height="100%"
                                alt="">
                            @endif
                            @endif
                            @endforeach
                    ...
                    <div class="card-header bg-white">
                        <div class="media">
                            <div class="media-left media-middle">
                                <a href="">
                                    <img src="{{ asset('dist/img/courses/c1.jpg') }}" alt="Card image cap" width="100"
                                        class="rounded">
                                </a>
                            </div>
                            <div class="media-body media-middle">
                                <h4 class="card-title"><a href="instructor-course-edit.html">Npm &amp; Gulp Advanced
                                        Workflow</a></h4>
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <div class="media">
                                <div class="media-left media-middle">
                                    <a href="">
                                        <img src="{{ asset('dist/img/courses/c1.jpg') }}" alt="Card image cap"
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="simple-card">
                            ...
                            <p class="simple-card-desc">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Optio
                                cupiditate, eius illo sapiente repellat recusandae quo tempora totam corrupti.</p>
                            <a class="" href="">
                                <button type="submit" class="download-form-submit">Tải về</button>
                            </a>
                            <span class="meta_info"><i style="color: red; padding-top: 17px"
                                    class="ti-share float-xl-right"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
