...
class BlogCategoryController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view("admin.page.blog-category.edit")->with([
            "cates" => $cate,
            "cate_list" => $categoryList
        ]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Blog_Cats $blog_Cats)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Blog_Cats $blog_Cats)
    {
        //
    }
}
